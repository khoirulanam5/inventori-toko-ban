              ...
              <th class="text-center">Verifikasi Admin</th>
                ...
                <td>
                  ...
                  <?php endif; ?>
								...
								<td>
                                <?php if($value->verifikasi == NULL): ?>
                  <button class="btn btn-sm btn-primary m-1" data-toggle="modal" data-target="#edit<?= $value->id_barang_keluar ?>"><i class="fas fa-edit fa-sm"></i></button>
                  <a class="btn btn-danger btn-sm m-1 hapus" href="<?= base_url('karyawan/barang_keluar/delete/'.$value->id_barang_keluar) ?>"><i class="fas fa-trash"></i></a>
                  <?php endif; ?>
								</td>
							</tr>
						<?php endforeach; ?>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?= base_url('karyawan/barang_keluar/add') ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
        		...
        		<input type="number" name="jml_keluar" id="jml_keluar" class="form-control" required>
        	</div>
            <div class="form-group">
...
<div class="modal fade" id="edit<?= $value->id_barang_keluar ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-body">
        <form action="<?= base_url('karyawan/barang_keluar/edit/' . $value->id_barang_keluar) ?>" method="post" enctype="multipart/form-data">
        	<div class="form-group">
        		<label>Nama Barang</label>
                <select class="form-control" name="id_stok" id="id_stok">
                    <option value="">-- Pilih Barang --</option>
            ...
            <div class="form-group">
        		<label>Jumlah Barang Keluar</label>
        		<input type="number" name="jml_keluar" id="jml_keluar" class="form-control" value="<?= $value->jml_keluar ?>" required>
        	</div>
            <div class="form-group">
                <label>Keterangan</label>
